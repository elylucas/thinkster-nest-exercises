...
const defaultData: ConfAppDb = {
  rooms: [
    {
      id: 1,
      createdAt: new Date('2021-01-14T20:54:28.754Z'),
      createdBy: 'admin',
  ...
  sessions: [
    {
      ...
      time: new Date('2021-01-14T08:00Z'),
      roomId: 1,
      createdAt: new Date('2021-01-14T20:54:28.754Z'),
      createdBy: 'admin',
      level: 'intermediate'
    },
    {
      ...
      time: new Date('2021-01-14T09:00Z'),
      roomId: 2,
      createdAt: new Date('2021-01-14T20:54:28.754Z'),
      createdBy: 'admin',
      level: 'beginner'
    },
    {
      ...
      time: new Date('2021-01-14T10:00Z'),
      roomId: 3,
      createdAt: new Date('2021-01-14T20:54:28.754Z'),
      createdBy: 'admin',
      level: 'advanced'
    },
    {
      ...
      time: new Date('2021-01-14T11:00Z'),
      roomId: 3,
      createdAt: new Date('2021-01-14T20:54:28.754Z'),
      createdBy: 'admin',
      level: 'beginner'
